...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const fetchHomepage = async () => {
      try {
        const resp = await api.homepage.get();
        const data = resp.data || {};
        // featured_properties may be an array of property IDs; backend may return objects depending on implementation
        setProperties(data.featured_properties || []);
        setPremiumBadges(data.premium_badges || []);
